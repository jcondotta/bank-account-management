...
public interface AddJointAccountHolderController {
    ...
    @Operation(
        ...
        requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
            ...
            content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE,
                schema = @Schema(implementation = AddJointAccountHolderRestRequest.class)
            )
        )
    )
    @ApiResponses(value = {
        @ApiResponse(
            ...
            content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = AddJointAccountHolderRestResponse.class)),
            headers = {
    ...
    ResponseEntity<AddJointAccountHolderRestResponse> createJointAccountHolder(
            @Parameter(
            ...
            @Valid @RequestBody AddJointAccountHolderRestRequest request);
}