...
class CreateAccountHolderDataRequestTest {
...
//        var accountHolderRequest = new CreateAccountHolderRestRequest(blankAccountHolderName, DATE_OF_BIRTH_JEFFERSON, PASSPORT_NUMBER_JEFFERSON);
//
...
//        var accountHolderRequest = new CreateAccountHolderRestRequest(veryLongAccountHolderName, DATE_OF_BIRTH_JEFFERSON, PASSPORT_NUMBER_JEFFERSON);
//
//        var exception = assertThrowsExactly(ConstraintViolationException.class, () ->
//            accountHolderRequest.validateWith(VALIDATOR)
//        );
...
//        var accountHolderRequest = new CreateAccountHolderRestRequest(ACCOUNT_HOLDER_NAME_JEFFERSON, futureDate, PASSPORT_NUMBER_JEFFERSON);
//
//        var exception = assertThrowsExactly(ConstraintViolationException.class, () ->
//            accountHolderRequest.validateWith(VALIDATOR)
//        );
...
//        var accountHolderRequest = new CreateAccountHolderRestRequest(ACCOUNT_HOLDER_NAME_JEFFERSON, today, PASSPORT_NUMBER_JEFFERSON);
//
//        var exception = assertThrowsExactly(ConstraintViolationException.class, () ->
//            accountHolderRequest.validateWith(VALIDATOR)
//        );
...
//        var accountHolderRequest = new CreateAccountHolderRestRequest(ACCOUNT_HOLDER_NAME_JEFFERSON, DATE_OF_BIRTH_JEFFERSON, null);
//
//        var exception = assertThrowsExactly(ConstraintViolationException.class, () ->
//            accountHolderRequest.validateWith(VALIDATOR)
//        );
...
//        var accountHolderRequest = new CreateAccountHolderRestRequest(ACCOUNT_HOLDER_NAME_JEFFERSON, DATE_OF_BIRTH_JEFFERSON, invalidLengthPassportNumber);
//
//        var exception = assertThrowsExactly(ConstraintViolationException.class, () ->
//            accountHolderRequest.validateWith(VALIDATOR)
//        );
...
//        var accountHolder = new CreateAccountHolderRestRequest(null, null, null);
//        var request = new AddJointAccountHolderRestRequest(accountHolder);
//
