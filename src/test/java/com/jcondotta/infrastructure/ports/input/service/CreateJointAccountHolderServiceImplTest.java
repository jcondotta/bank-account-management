...
class CreateJointAccountHolderServiceImplTest {
    ...
    @BeforeEach
    void beforeEach() {
        createJointAccountHolderService = new CreateJointAccountHolderServiceImpl(repository, TEST_CLOCK_FIXED_INSTANT, VALIDATOR, BANKING_ENTITY_MAPPER);
    }
    ...
    void shouldCreateJointAccountHolder_whenRequestIsValid() {
        ...
        createJointAccountHolderService.createJointAccountHolder(BANK_ACCOUNT_ID_BRAZIL, createJointAccountHoldersRequest);

        var bankingEntityCaptor = ArgumentCaptor.forClass(BankingEntity.class);
        verify(repository).createJointAccountHolder(bankingEntityCaptor.capture());
    ...
    void shouldThrowConstraintViolationException_whenBankAccountIdIsNull() {
        ...
        var exception = assertThrows(NullPointerException.class, () ->
                createJointAccountHolderService.createJointAccountHolder(null, createJointAccountHoldersRequest)
        );
