...
class CreateBankAccountCommandTest {
...
//        var accountHolderDetailsRequest = new CreateAccountHolderRestRequest(ACCOUNT_HOLDER_NAME_JEFFERSON, DATE_OF_BIRTH_JEFFERSON, PASSPORT_NUMBER_JEFFERSON);
//        var createBankAccountRequest = CreateBankAccountRestRequest.builder()
...
//            .accountHolder(new CreateAccountHolderRestRequest(
...
//        var accountHolderDetailsRequest = new CreateAccountHolderRestRequest(
